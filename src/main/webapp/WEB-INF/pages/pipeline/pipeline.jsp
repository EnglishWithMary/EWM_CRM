                    ...
                    <c:forEach items="${card.persons}" var="person">
                        ...
                        <div class="person">
                            ...
                            <div class="person-edit-tool-bar">
                                ...
                                <div>
                                    <button type="button" class="btn btn-default btn-xs" data-toggle="modal" data-target="#modal${person.id}">
                                        <span class="glyphicon glyphicon-remove"></span>
                                    </button>
                                    <div class="modal fade" id="modal${person.id}" data-backdrop="false">
